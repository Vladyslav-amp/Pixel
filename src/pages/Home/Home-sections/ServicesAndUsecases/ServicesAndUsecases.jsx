      ...
      <div className="servicesandusecases-block">
        ...
        <div className="servicesandusecases-bottom">
          ...
          <div className="servicesandusecases-bottom__branding servicesandusecases-bottom__widgets--desktop">
            <Widget
              size="sm"
              imageSrc="src/assets/images/widgets/branding-service.png"
              text="Branding"
          ...
          <div className="servicesandusecases-bottom__works-check servicesandusecases-bottom__widgets--desktop">
            <Widget size="lg" imageSrc="src/assets/images/widgets/checkwhatyouneed.png" text="Check what you need" />
          </div>
          ...
          <div className="servicesandusecases-bottom__works-work servicesandusecases-bottom__works-work--mobile">
            <Widget size="sm" imageSrc="src/assets/images/widgets/uriel.png" text="Uriel Saenz Brand books" />
          </div>

          <div className="servicesandusecases-bottom__works-work servicesandusecases-bottom__works-work--mobile">
            <Widget size="sm" imageSrc="src/assets/images/widgets/janice.png" text="Janice website" />
          </div>

          <div className="servicesandusecases-bottom__works-work servicesandusecases-bottom__works-work--mobile">
            <Widget size="sm" imageSrc="src/assets/images/widgets/placeforyou.png" text="Place for you" />
          </div>
