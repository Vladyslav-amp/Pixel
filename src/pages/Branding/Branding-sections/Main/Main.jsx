    ...
    <section id={id} className="main">
      <div className="main-block">
        <div className="main-block__widget">
          <Widget size="lg" imageSrc="@/assets/images/widgets/video.png" text="Check what you need" />
        </div>

        <div className="main-block__widget">
          <Widget size="sm" imageSrc="@/assets/images/widgets/pixel-mate.png" text="Check what you need" />
        </div>
