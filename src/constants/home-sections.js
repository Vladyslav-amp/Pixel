export const NAV = [
  { type: 'section', id: 'Main', label: 'PIXEL' },
  { type: 'section', id: 'ServicesAndUsecases', label: 'SERVICES AND USE CASES' },
  { type: 'route', to: '/Branding', label: 'BRANDING' },
  { type: 'route', to: '/siteandapps', label: 'SITE AND APP`S' },
